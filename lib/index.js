...
(function() {
  ...
  EPub = class EPub {
    ...
    generateTempFile() {
      var base, coverPath, generateDefer, htmlTocPath, ncxTocPath, opfPath, self;
      ...
      Q.all([Q.nfcall(ejs.renderFile, opfPath, self.options), Q.nfcall(ejs.renderFile, ncxTocPath, self.options), Q.nfcall(ejs.renderFile, htmlTocPath, self.options), Q.nfcall(ejs.renderFile, coverPath, self.options)]).spread(function(data1, data2, data3, data4) {
